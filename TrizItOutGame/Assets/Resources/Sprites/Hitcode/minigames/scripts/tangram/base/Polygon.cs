...
namespace Hitcode_tangram
{
    public class Polygon
    {
        ...
        private static bool FormsEar(Vector2[] points, int A, int B, int C)
        {
        ...
        {
            Vector2[] pts = new Vector2[Points.Length - 1];
        ...
        public List<Triangle> Triangulate()
        {
            ...
            Vector2[] pts = new Vector2[Points.Length];
        ...
        private Vector2[] CurrentRectangle = null;
        private float BestArea = float.MaxValue;
        private Vector2[] BestRectangle = null;
        ...
        private void FindBoundingRectangle()
        {
            ...
            CurrentRectangle = new Vector2[4];
        ...
        public Vector2[] FindSmallestBoundingRectangle()
        {
